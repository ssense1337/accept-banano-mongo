...
func TestBlockCreate(t *testing.T) {
	...
	cases := []TestCase{
		// Receive
		{
			...
			"ban_3dqpukm9df5dzkq38reosmxwxu3yfphm5hm5ewn5j6axd5pw5gwyqc9dhefx",
			"ban_1ninja7rh37ehfp9utkor5ixmxyg8kme8fnzc4zty145ibch8kf5jwpnzr3r",
			...
			blockType{
				Type:           "state",
				Account:        "ban_3dqpukm9df5dzkq38reosmxwxu3yfphm5hm5ewn5j6axd5pw5gwyqc9dhefx",
				...
				LinkAsAccount:  "ban_1gait7h88ia74aujrgznobxps9gjrq7drdwyp5q3ch6k4jimzykk3wjdpx6u",
		...
		// Send
		{
			...
			blockType{
				...
				LinkAsAccount:  "ban_1cenk13d5i7qi51ox3m8ipdqecuagopihyb5snffd49b8zo6pq68gqc89nfw",
